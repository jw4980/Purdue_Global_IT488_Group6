...
namespace eBIT_Application {
    ...
    public partial class eBITDataSet1 : global::System.Data.DataSet {
        ...
        private void InitClass() {
            ...
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/eBITDataSet11.xsd";
        ...
        public partial class inventoryDataTable : global::System.Data.TypedTableBase<inventoryRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public inventoryRow AddinventoryRow(product_categoryRow parentproduct_categoryRowByFK__inventory__categ__68487DD7) {
...
namespace eBIT_Application.eBITDataSet1TableAdapters {
    ...
    public partial class inventoryTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT category_id FROM dbo.inventory";
    ...
    public partial class product_categoryTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[product_category] SET [category_id] = @category_id, [category_name] = @category_name WHERE (([category_id] = @Original_category_id) AND ([category_name] = @Original_category_name));
SELECT category_id, category_name FROM product_category WHERE (category_id = @category_id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT category_id, category_name FROM dbo.product_category";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
