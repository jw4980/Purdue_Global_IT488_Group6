...
-- Use ONLY if product_category table does not include category_name field or if you need to reorder fields
-- Delete category_desc from product_category table, then add category_name and category_desc in correct order
...
VALUES
    ...
    ('Guitar', 25, 8, 199.99, 159.99, '2023-02-15', '2023-03-01'),
